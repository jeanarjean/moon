defmodule MoonWeb.Router do
  ...
  import MoonWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {MoonWeb.Layouts, :root}
  ...
  if Application.compile_env(:moon, :dev_routes) do
  ...
  scope "/", MoonWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{MoonWeb.UserAuth, :require_authenticated}] do
  ...
  scope "/", MoonWeb do
    ...
    live_session :current_user,
      on_mount: [{MoonWeb.UserAuth, :mount_current_scope}] do
